...
public class WebSocketChannelWriter implements ChannelWriter {

	private static final Logger log = Logger.getLogger(WebSocketChannelWriter.class);
	
	private Channel channel;
	
	public WebSocketChannelWriter(Channel channel) {
